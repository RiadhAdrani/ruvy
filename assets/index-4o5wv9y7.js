...
\`\`\`
`,Pi=`# Beyond React: Exploring Additional Features and Differences
...
`,Hi=[{from:"0.5.0",to:"0.5.0",md:$i},{from:"0.5.2",md:zi}],Ji=`# mountApp
...
`,Gi=[{from:"0.5.0",to:"0.5.0",md:Ji},{from:"0.5.2",md:Wi}],ji=`# useState
...
`,Yi=[{from:"0.5.0",to:"0.5.0",md:ji},{from:"0.5.2",md:Zi}],qi=`# useEffect
...
`,Xi=[{from:"0.5.0",to:"0.5.0",md:qi},{from:"0.5.2",md:Vi}],Qi=`# useMemo
...
In other words, useMemo caches a calculation result between re-renders until its dependencies change.
`,el=[{from:"0.5.0",to:"0.5.0",md:Qi},{from:"0.5.2",md:Ki}],tl=`# API
...
- [\`<Portal/>\`](/docs/api/portal)
- [\`<Fragment/>\`](/docs/api/fragment)
`,rl=[{from:"0.5.0",to:"0.5.0",md:tl},{from:"0.5.2",md:nl}],ol=[{path:"/mountApp",versions:Gi,title:"mountApp"},{path:"/createRouter",versions:Hi,title:"createRouter"},{path:"/createStore",versions:[{from:"0.5.0",to:"0.5.0",md:Ii}],title:"createStore"},{path:"/useState",versions:Yi,title:"useState"},{path:"/useEffect",versions:Xi,title:"useEffect"},{path:"/useMemo",versions:el,title:"useMemo"},{path:"/useCallback",versions:[{from:"0.5.0",md:xi}],title:"useCallback"},{path:"/useContext",versions:[{from:"0.5.0",md:Fi}],title:"useContext"},{path:"/useId",versions:[{from:"0.5.0",md:ki}],title:"useId"},{path:"/createContext",versions:[{from:"0.5.0",md:Ei}],title:"createContext"},{path:"/getParams",versions:[{from:"0.5.0",md:Ai}],title:"getParams"},{path:"/getSearchParams",versions:[{from:"0.5.0",md:Ti}],title:"getSearchParams"},{path:"/getPathname",versions:[{from:"0.5.0",md:Ci}],title:"getPathname"},{path:"/replace",versions:[{from:"0.5.0",to:"0.5.0",md:kr}],element:kr,title:"replace"},{path:"/navigate",versions:[{from:"0.5.0",md:Si}],title:"navigate"},{path:"/batch",versions:[{from:"0.5.0",to:"0.5.0",md:Er}],element:Er,title:"batch"},{path:"/outlet",versions:[{from:"0.5.0",md:Ri}],title:"<Outlet/>"},{path:"/fragment",versions:[{from:"0.5.0",md:_i}],title:"<Fragment/>"},{path:"/portal",versions:[{from:"0.5.0",md:Bi}],title:"<Portal/>"}],al=[{path:"/class-attribute",versions:[{from:"0.5.0",md:Mi}],title:"Class attribute"},{path:"/joinClasses",versions:[{from:"0.5.0",md:Li}],title:"joinClasses"},{path:"/if-directive",versions:[{from:"0.5.0",md:Ni}],title:"if directives"},{path:"/switch-directive",versions:[{from:"0.5.0",md:Oi}],title:"switch directives"},{path:"/event-modifiers",versions:[{from:"0.5.0",md:Ui}],title:"Event modifiers"}],Ar=[{path:"/api",title:"API",children:ol,versions:rl},{path:"/more",title:"More",children:al,versions:[{from:"0.5.0",md:Pi}]},{path:"/types",title:"Types",children:[],versions:[{from:"0.5.0",md:Di}]}],sl=`# Quick Start
...
- SPA Router.
- key-value Store.
`,hl=()=>createJsxElement(Ue,{content:dl}),pl=[{path:"/",element:createJsxElement(createJsxFragmentElement,null,createJsxElement(ul,null),createJsxElement("div",{class:"w-100% overflow-x-hidden row-center p-x-6 m-t-[var(--nav-bar-height)]",style:{minHeight:"calc(100vh - var(--nav-bar-height))"}},createJsxElement("div",{class:"col max-w-1200px flex-1 self-stretch overflow-x-hidden p-y-12 md:p-y-10"},createJsxElement(st,null)))),children:[{path:"",title:"Home",element:createJsxElement(fi,null),name:"Home"},{path:"/docs",title:"Docs",element:createJsxElement(xr,null)},{path:"/learn",title:"Learn",element:createJsxElement(Fr,null),name:"Learn"},{path:"/changelogs",title:"Changelogs",element:createJsxElement(hl,null),name:"ChangeLogs"},{path:"/acknowledgment",title:"Acknowledgment",element:createJsxElement(bi,null)},{path:"/examples",title:"Examples",element:createJsxElement(wi,null)},{path:"/*",element:createJsxElement(wo,null)},{path:"/learn",element:createJsxElement(Sr,{rootURL:"/learn",sideBarItems:Cr}),children:[{path:"",element:createJsxElement(Fr,null)},...Cr.map(n=>({path:n.path,element:createJsxElement(on,{versions:n.versions})}))]},{path:"/docs",element:createJsxElement(Sr,{rootURL:"/docs",sideBarItems:Ar}),children:[{path:"",element:createJsxElement(xr,null)},...Ar.map(n=>({path:n.path,element:createJsxElement(st,null),children:[{path:"",element:createJsxElement(on,{versions:n.versions})},...n.children.map(e=>({path:e.path,element:createJsxElement(on,{versions:e.versions})}))]}))]}]}];Oa({routes:pl,base:"/ruvy",transformTitle:n=>`${n} - Ruvy`,correctScrolling:!0});ka({app:createJsxElement(ms,null),host:document.querySelector("#app")});
