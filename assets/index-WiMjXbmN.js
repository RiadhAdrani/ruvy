...
`,e=e.substring(m.length+1),_=!0),!_){const b=new RegExp(`^ {0,${Math.min(3,i-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),g=new RegExp(`^ {0,${Math.min(3,i-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),v=new RegExp(`^ {0,${Math.min(3,i-1)}}(?:\`\`\`|~~~)`),F=new RegExp(`^ {0,${Math.min(3,i-1)}}#`);for(;e&&(f=e.split(`
`,1)[0],m=f,this.options.pedantic&&(m=m.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),!(v.test(m)||F.test(m)||b.test(m)||g.test(e)));){if(m.search(/[^ ]/)>=i||!m.trim())y+=`
`+m.slice(i);else{if(l||p.search(/[^ ]/)>=4||v.test(p)||F.test(p)||g.test(p))break;y+=`
`+m}!l&&!m.trim()&&(l=!0),r+=f+`
...
\`\`\`
`,ki=`# Beyond React: Exploring Additional Features and Differences
...
`,Bi=[{from:"0.5.0",to:"0.5.0",md:Ri},{from:"0.5.2",md:_i}],Ii=`# createComposable
...
`,Pi=[{from:"0.5.2",md:Ii}],Mi=`# createContext
...
`,Ni=[{from:"0.5.0",to:"0.5.0",md:Mi},{from:"0.5.2",md:Li}],Oi=`# mountApp
...
`,zi=[{from:"0.5.0",to:"0.5.0",md:Oi},{from:"0.5.2",md:Ui}],$i=`# useState
...
`,ji=[{from:"0.5.0",to:"0.5.0",md:$i},{from:"0.5.2",md:Hi}],Ji=`# useEffect
...
`,Gi=[{from:"0.5.0",to:"0.5.0",md:Ji},{from:"0.5.2",md:Wi}],Zi=`# useMemo
...
`,Yi=[{from:"0.5.0",to:"0.5.0",md:Zi},{from:"0.5.2",md:qi}],Vi=`# useCallback
...
`,Qi=[{from:"0.5.0",to:"0.5.0",md:Vi},{from:"0.5.2",md:Xi}],Ki=`# useId
...
`,tl=[{from:"0.5.0",to:"0.5.0",md:Ki},{from:"0.5.2",md:el}],nl=`# useContext
...
<iframe src="https://stackblitz.com/edit/ruvy-jewpid?embed=1&file=src%2FCount.tsx&hideExplorer=1&hideNavigation=1" class="stackblitz"></iframe>
`,ol=[{from:"0.5.0",to:"0.5.0",md:nl},{from:"0.5.2",md:rl}],al=`# useComposable
...
<iframe src="https://stackblitz.com/edit/ruvy-lqiij9?embed=1&file=src%2FCount.tsx&hideExplorer=1&hideNavigation=1" class="stackblitz"></iframe>
`,sl=[{from:"0.5.2",md:al}],il=`# getParams
...
\`\`\`
`,ul=[{from:"0.5.0",to:"0.5.0",md:ll},{from:"0.5.2",md:il}],cl=`# getSearchParams
...
\`\`\`
`,hl=[{from:"0.5.0",to:"0.5.0",md:dl},{from:"0.5.2",md:cl}],pl=`# getPathname
...
\`\`\`
`,fl=[{from:"0.5.0",to:"0.5.0",md:ml},{from:"0.5.2",md:pl}],gl=`# navigate
...
`,xl=[{from:"0.5.0",to:"0.5.0",md:wl},{from:"0.5.2",md:vl}],Dl=`# Fragment
...
`,kl=[{from:"0.5.0",to:"0.5.0",md:Dl},{from:"0.5.2",md:Fl}],El=`# API
...
- [\`<Portal/>\`](/docs/api/portal)
- [\`<Fragment/>\`](/docs/api/fragment)
`,Al=[{from:"0.5.0",to:"0.5.0",md:El},{from:"0.5.2",md:Cl}],Tl=[{path:"/mountApp",versions:zi,title:"mountApp"},{path:"/createRouter",versions:Bi,title:"createRouter"},{path:"/createStore",versions:[{from:"0.5.0",to:"0.5.0",md:Fi}],title:"createStore"},{path:"/createComposable",versions:Pi,title:"createComposable"},{path:"/useState",versions:ji,title:"useState"},{path:"/useEffect",versions:Gi,title:"useEffect"},{path:"/useMemo",versions:Yi,title:"useMemo"},{path:"/useCallback",versions:Qi,title:"useCallback"},{path:"/useContext",versions:ol,title:"useContext"},{path:"/useComposable",versions:sl,title:"useComposable"},{path:"/useId",versions:tl,title:"useId"},{path:"/createContext",versions:Ni,title:"createContext"},{path:"/getParams",versions:ul,title:"getParams"},{path:"/getSearchParams",versions:hl,title:"getSearchParams"},{path:"/getPathname",versions:fl,title:"getPathname"},{path:"/replace",versions:[{from:"0.5.0",to:"0.5.0",md:kr}],element:kr,title:"replace"},{path:"/navigate",versions:yl,title:"navigate"},{path:"/batch",versions:[{from:"0.5.0",to:"0.5.0",md:Er}],element:Er,title:"batch"},{path:"/outlet",versions:xl,title:"<Outlet/>"},{path:"/fragment",versions:kl,title:"<Fragment/>"},{path:"/portal",versions:[{from:"0.5.0",md:Di}],title:"<Portal/>"}],Sl=[{path:"/class-attribute",versions:[{from:"0.5.0",md:Ei}],title:"Class attribute"},{path:"/joinClasses",versions:[{from:"0.5.0",md:Ci}],title:"joinClasses"},{path:"/if-directive",versions:[{from:"0.5.0",md:Ai}],title:"if directives"},{path:"/switch-directive",versions:[{from:"0.5.0",md:Ti}],title:"switch directives"},{path:"/event-modifiers",versions:[{from:"0.5.0",md:Si}],title:"Event modifiers"}],Cr=[{path:"/api",title:"API",children:Tl,versions:Al},{path:"/more",title:"More",children:Sl,versions:[{from:"0.5.0",md:ki}]},{path:"/types",title:"Types",children:[],versions:[{from:"0.5.0",md:xi}]}],Rl=`# Quick Start
...
- SPA Router.
- key-value Store.
`,Ll=()=>createJsxElement(Ue,{content:Ml}),Nl=[{path:"/",element:createJsxElement(createJsxFragmentElement,null,createJsxElement(Il,null),createJsxElement("div",{class:"w-100% overflow-x-hidden row-center p-x-6 m-t-[var(--nav-bar-height)]",style:{minHeight:"calc(100vh - var(--nav-bar-height))"}},createJsxElement("div",{class:"col max-w-1200px flex-1 self-stretch overflow-x-hidden p-y-12 md:p-y-10"},createJsxElement(st,null)))),children:[{path:"",title:"Home",element:createJsxElement(mi,null),name:"Home"},{path:"/docs",title:"Docs",element:createJsxElement(Dr,null)},{path:"/learn",title:"Learn",element:createJsxElement(Fr,null),name:"Learn"},{path:"/changelogs",title:"Changelogs",element:createJsxElement(Ll,null),name:"ChangeLogs"},{path:"/acknowledgment",title:"Acknowledgment",element:createJsxElement(bi,null)},{path:"/examples",title:"Examples",element:createJsxElement(wi,null)},{path:"/*",element:createJsxElement(wo,null)},{path:"/learn",element:createJsxElement(Sr,{rootURL:"/learn",sideBarItems:Ar}),children:[{path:"",element:createJsxElement(Fr,null)},...Ar.map(n=>({path:n.path,element:createJsxElement(on,{versions:n.versions})}))]},{path:"/docs",element:createJsxElement(Sr,{rootURL:"/docs",sideBarItems:Cr}),children:[{path:"",element:createJsxElement(Dr,null)},...Cr.map(n=>({path:n.path,element:createJsxElement(st,null),children:[{path:"",element:createJsxElement(on,{versions:n.versions})},...n.children.map(e=>({path:e.path,element:createJsxElement(on,{versions:e.versions})}))]}))]}]}];Oa({routes:Nl,base:"/ruvy",transformTitle:n=>`${n} - Ruvy`,correctScrolling:!0});ka({app:createJsxElement(fs,null),host:document.querySelector("#app")});
