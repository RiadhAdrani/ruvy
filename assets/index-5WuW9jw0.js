...
\`\`\`
`,Si=`# Beyond React: Exploring Additional Features and Differences
...
`,Ni=[{from:"0.5.0",to:"0.5.0",md:Mi},{from:"0.5.2",md:Li}],Oi=`# createComposable
...
`,Ui=[{from:"0.5.2",md:Oi}],zi=`# createContext
...
`,Hi=[{from:"0.5.0",to:"0.5.0",md:zi},{from:"0.5.2",md:$i}],ji=`# mountApp
...
`,Wi=[{from:"0.5.0",to:"0.5.0",md:ji},{from:"0.5.2",md:Ji}],Gi=`# useState
...
`,qi=[{from:"0.5.0",to:"0.5.0",md:Gi},{from:"0.5.2",md:Zi}],Yi=`# useEffect
...
`,Xi=[{from:"0.5.0",to:"0.5.0",md:Yi},{from:"0.5.2",md:Vi}],Qi=`# useMemo
...
`,el=[{from:"0.5.0",to:"0.5.0",md:Qi},{from:"0.5.2",md:Ki}],tl=`# useCallback
...
`,rl=[{from:"0.5.0",to:"0.5.0",md:tl},{from:"0.5.2",md:nl}],ol=`# useId
...
`,sl=[{from:"0.5.0",to:"0.5.0",md:ol},{from:"0.5.2",md:al}],il=`# useContext
...
<iframe src="https://stackblitz.com/edit/ruvy-jewpid?embed=1&file=src%2FCount.tsx&hideExplorer=1&hideNavigation=1" class="stackblitz"></iframe>
`,ul=[{from:"0.5.0",to:"0.5.0",md:il},{from:"0.5.2",md:ll}],cl=`# useComposable
...
<iframe src="https://stackblitz.com/edit/ruvy-lqiij9?embed=1&file=src%2FCount.tsx&hideExplorer=1&hideNavigation=1" class="stackblitz"></iframe>
`,dl=[{from:"0.5.2",md:cl}],hl=`# getParams
...
\`\`\`
`,fl=[{from:"0.5.0",to:"0.5.0",md:pl},{from:"0.5.2",md:hl}],ml=`# API
...
- [\`<Portal/>\`](/docs/api/portal)
- [\`<Fragment/>\`](/docs/api/fragment)
`,bl=[{from:"0.5.0",to:"0.5.0",md:ml},{from:"0.5.2",md:gl}],yl=[{path:"/mountApp",versions:Wi,title:"mountApp"},{path:"/createRouter",versions:Ni,title:"createRouter"},{path:"/createStore",versions:[{from:"0.5.0",to:"0.5.0",md:Ti}],title:"createStore"},{path:"/createComposable",versions:Ui,title:"createComposable"},{path:"/useState",versions:qi,title:"useState"},{path:"/useEffect",versions:Xi,title:"useEffect"},{path:"/useMemo",versions:el,title:"useMemo"},{path:"/useCallback",versions:rl,title:"useCallback"},{path:"/useContext",versions:ul,title:"useContext"},{path:"/useComposable",versions:dl,title:"useComposable"},{path:"/useId",versions:sl,title:"useId"},{path:"/createContext",versions:Hi,title:"createContext"},{path:"/getParams",versions:fl,title:"getParams"},{path:"/getSearchParams",versions:[{from:"0.5.0",md:Fi}],title:"getSearchParams"},{path:"/getPathname",versions:[{from:"0.5.0",md:Di}],title:"getPathname"},{path:"/replace",versions:[{from:"0.5.0",to:"0.5.0",md:kr}],element:kr,title:"replace"},{path:"/navigate",versions:[{from:"0.5.0",md:ki}],title:"navigate"},{path:"/batch",versions:[{from:"0.5.0",to:"0.5.0",md:Er}],element:Er,title:"batch"},{path:"/outlet",versions:[{from:"0.5.0",md:Ei}],title:"<Outlet/>"},{path:"/fragment",versions:[{from:"0.5.0",md:Ai}],title:"<Fragment/>"},{path:"/portal",versions:[{from:"0.5.0",md:Ci}],title:"<Portal/>"}],wl=[{path:"/class-attribute",versions:[{from:"0.5.0",md:Ri}],title:"Class attribute"},{path:"/joinClasses",versions:[{from:"0.5.0",md:_i}],title:"joinClasses"},{path:"/if-directive",versions:[{from:"0.5.0",md:Bi}],title:"if directives"},{path:"/switch-directive",versions:[{from:"0.5.0",md:Ii}],title:"switch directives"},{path:"/event-modifiers",versions:[{from:"0.5.0",md:Pi}],title:"Event modifiers"}],Cr=[{path:"/api",title:"API",children:yl,versions:bl},{path:"/more",title:"More",children:wl,versions:[{from:"0.5.0",md:Si}]},{path:"/types",title:"Types",children:[],versions:[{from:"0.5.0",md:xi}]}],vl=`# Quick Start
