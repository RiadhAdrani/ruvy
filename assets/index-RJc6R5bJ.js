...
\`\`\`
`,Fi=`# Beyond React: Exploring Additional Features and Differences
...
`,_i=[{from:"0.5.0",to:"0.5.0",md:Si},{from:"0.5.2",md:Ri}],Bi=`# createComposable
...
`,Ui=[{from:"0.5.0",to:"0.5.0",md:Ni},{from:"0.5.2",md:Oi}],zi=`# useState
...
`,Hi=[{from:"0.5.0",to:"0.5.0",md:zi},{from:"0.5.2",md:$i}],ji=`# useEffect
...
`,qi=[{from:"0.5.0",to:"0.5.0",md:Gi},{from:"0.5.2",md:Zi}],Yi=`# useCallback
...
`,Xi=[{from:"0.5.0",to:"0.5.0",md:Yi},{from:"0.5.2",md:Vi}],Qi=`# useId
...
<iframe src="https://stackblitz.com/edit/ruvy-jewpid?embed=1&file=src%2FCount.tsx&hideExplorer=1&hideNavigation=1" class="stackblitz"></iframe>
`,rl=[{from:"0.5.0",to:"0.5.0",md:tl},{from:"0.5.2",md:nl}],ol=`# useComposable
...
<iframe src="https://stackblitz.com/edit/ruvy-lqiij9?embed=1&file=src%2FCount.tsx&hideExplorer=1&hideNavigation=1" class="stackblitz"></iframe>
`,al=[{from:"0.5.2",md:ol}],sl=`# getParams
...
`,vl=[{from:"0.5.0",to:"0.5.0",md:yl},{from:"0.5.2",md:wl}],xl=`# Fragment
...
`,Fl=[{from:"0.5.0",to:"0.5.0",md:xl},{from:"0.5.2",md:Dl}],kl=`# Portal
...
`,Cl=[{from:"0.5.0",to:"0.5.0",md:kl},{from:"0.5.2",md:El}],Al=`# API
...
- [\`<Portal/>\`](/docs/api/portal)
- [\`<Fragment/>\`](/docs/api/fragment)
`,Sl=[{from:"0.5.0",to:"0.5.0",md:Al},{from:"0.5.2",md:Tl}],Rl=[{path:"/mountApp",versions:Ui,title:"mountApp"},{path:"/createRouter",versions:_i,title:"createRouter"},{path:"/createStore",versions:[{from:"0.5.0",to:"0.5.0",md:Di}],title:"createStore"},{path:"/createComposable",versions:Ii,title:"createComposable"},{path:"/useState",versions:Hi,title:"useState"},{path:"/useEffect",versions:Wi,title:"useEffect"},{path:"/useMemo",versions:qi,title:"useMemo"},{path:"/useCallback",versions:Xi,title:"useCallback"},{path:"/useContext",versions:rl,title:"useContext"},{path:"/useComposable",versions:al,title:"useComposable"},{path:"/useId",versions:el,title:"useId"},{path:"/createContext",versions:Li,title:"createContext"},{path:"/getParams",versions:ll,title:"getParams"},{path:"/getSearchParams",versions:dl,title:"getSearchParams"},{path:"/getPathname",versions:ml,title:"getPathname"},{path:"/replace",versions:[{from:"0.5.0",to:"0.5.0",md:kr}],element:kr,title:"replace"},{path:"/navigate",versions:bl,title:"navigate"},{path:"/batch",versions:[{from:"0.5.0",to:"0.5.0",md:Er}],element:Er,title:"batch"},{path:"/outlet",versions:vl,title:"<Outlet/>"},{path:"/fragment",versions:Fl,title:"<Fragment/>"},{path:"/portal",versions:Cl,title:"<Portal/>"}],_l=[{path:"/class-attribute",versions:[{from:"0.5.0",md:ki}],title:"Class attribute"},{path:"/joinClasses",versions:[{from:"0.5.0",md:Ei}],title:"joinClasses"},{path:"/if-directive",versions:[{from:"0.5.0",md:Ci}],title:"if directives"},{path:"/switch-directive",versions:[{from:"0.5.0",md:Ai}],title:"switch directives"},{path:"/event-modifiers",versions:[{from:"0.5.0",md:Ti}],title:"Event modifiers"}],Cr=[{path:"/api",title:"API",children:Rl,versions:Sl},{path:"/more",title:"More",children:_l,versions:[{from:"0.5.0",md:Fi}]},{path:"/types",title:"Types",children:[],versions:[{from:"0.5.0",md:xi}]}],Bl=`# Quick Start
...
- SPA Router.
- key-value Store.
`,Ol=()=>createJsxElement(Ue,{content:Nl}),Ul=[{path:"/",element:createJsxElement(createJsxFragmentElement,null,createJsxElement(Ml,null),createJsxElement("div",{class:"w-100% overflow-x-hidden row-center p-x-6 m-t-[var(--nav-bar-height)]",style:{minHeight:"calc(100vh - var(--nav-bar-height))"}},createJsxElement("div",{class:"col max-w-1200px flex-1 self-stretch overflow-x-hidden p-y-12 md:p-y-10"},createJsxElement(st,null)))),children:[{path:"",title:"Home",element:createJsxElement(mi,null),name:"Home"},{path:"/docs",title:"Docs",element:createJsxElement(Dr,null)},{path:"/learn",title:"Learn",element:createJsxElement(Fr,null),name:"Learn"},{path:"/changelogs",title:"Changelogs",element:createJsxElement(Ol,null),name:"ChangeLogs"},{path:"/acknowledgment",title:"Acknowledgment",element:createJsxElement(bi,null)},{path:"/examples",title:"Examples",element:createJsxElement(wi,null)},{path:"/*",element:createJsxElement(wo,null)},{path:"/learn",element:createJsxElement(Sr,{rootURL:"/learn",sideBarItems:Ar}),children:[{path:"",element:createJsxElement(Fr,null)},...Ar.map(n=>({path:n.path,element:createJsxElement(on,{versions:n.versions})}))]},{path:"/docs",element:createJsxElement(Sr,{rootURL:"/docs",sideBarItems:Cr}),children:[{path:"",element:createJsxElement(Dr,null)},...Cr.map(n=>({path:n.path,element:createJsxElement(st,null),children:[{path:"",element:createJsxElement(on,{versions:n.versions})},...n.children.map(e=>({path:e.path,element:createJsxElement(on,{versions:e.versions})}))]}))]}]}];Oa({routes:Ul,base:"/ruvy",transformTitle:n=>`${n} - Ruvy`,correctScrolling:!0});ka({app:createJsxElement(fs,null),host:document.querySelector("#app")});
