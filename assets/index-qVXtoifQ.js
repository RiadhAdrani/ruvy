...
\`\`\`
`,$i=`# Beyond React: Exploring Additional Features and Differences
...
`,ji=[{path:"/mountApp",versions:[{from:"0.5.0",md:Pi}],title:"mountApp"},{path:"/createRouter",versions:[{from:"0.5.0",md:Ri}],title:"createRouter"},{path:"/createStore",versions:[{from:"0.5.0",to:"0.5.0",md:Ui}],title:"createStore"},{path:"/useState",versions:[{from:"0.5.0",md:Fi}],title:"useState"},{path:"/useEffect",versions:[{from:"0.5.0",md:Ei}],title:"useEffect"},{path:"/useMemo",versions:[{from:"0.5.0",md:ki}],title:"useMemo"},{path:"/useCallback",versions:[{from:"0.5.0",md:Ai}],title:"useCallback"},{path:"/useContext",versions:[{from:"0.5.0",md:Ci}],title:"useContext"},{path:"/useId",versions:[{from:"0.5.0",md:Ti}],title:"useId"},{path:"/createContext",versions:[{from:"0.5.0",md:Si}],title:"createContext"},{path:"/getParams",versions:[{from:"0.5.0",md:Bi}],title:"getParams"},{path:"/getSearchParams",versions:[{from:"0.5.0",md:Ii}],title:"getSearchParams"},{path:"/getPathname",versions:[{from:"0.5.0",md:_i}],title:"getPathname"},{path:"/replace",versions:[{from:"0.5.0",to:"0.5.0",md:Er}],element:Er,title:"replace"},{path:"/navigate",versions:[{from:"0.5.0",md:Mi}],title:"navigate"},{path:"/batch",versions:[{from:"0.5.0",to:"0.5.0",md:kr}],element:kr,title:"batch"},{path:"/outlet",versions:[{from:"0.5.0",md:Li}],title:"<Outlet/>"},{path:"/fragment",versions:[{from:"0.5.0",md:Oi}],title:"<Fragment/>"},{path:"/portal",versions:[{from:"0.5.0",md:Ni}],title:"<Portal/>"}],Zi=[{path:"/class-attribute",versions:[{from:"0.5.0",md:zi}],title:"Class attribute"},{path:"/joinClasses",versions:[{from:"0.5.0",md:Hi}],title:"joinClasses"},{path:"/if-directive",versions:[{from:"0.5.0",md:Gi}],title:"if directives"},{path:"/switch-directive",versions:[{from:"0.5.0",md:Ji}],title:"switch directives"},{path:"/event-modifiers",versions:[{from:"0.5.0",md:Wi}],title:"Event modifiers"}],Ar=[{path:"/api",title:"API",children:ji,versions:[{from:"0.5.0",md:Di}]},{path:"/more",title:"More",children:Zi,versions:[{from:"0.5.0",md:$i}]},{path:"/types",title:"Types",children:[],versions:[{from:"0.5.0",md:xi}]}],Yi=`# Quick Start
...
**\`🎉 Happy Coding ! 🎉\`**
`,Cr=[{path:"/quick-start",versions:[{from:"0.5.0",md:Yi}],title:"Quick Start"},{path:"/setup",versions:[{from:"0.5.0",md:qi}],title:"Setup"},{path:"/tutorial-todo",versions:[{from:"0.5.0",md:Vi}],title:"Tutorial : Todo"}],Tr=n=>createJsxElement("label",{...n,class:"switch rounded scale-55 u-border"},createJsxElement("input",{checked:n.checked,type:"checkbox","class:switch-input":!0}),createJsxElement("span",{class:"switch-slider rounded before:rounded"})),Ne=n=>{const{children:e,class:t,isActive:r}=n,o=he(()=>{let a="p-x-2 text-[0.9em]";return r?a+=" color-[var(--link)]":a+=" color-[var(--text-low)] hover:color-[var(--text-strong)]",Kr(a,t)},[t,r]);return createJsxElement("a",{...n,class:o},e)},Xi=()=>{const{computedTheme:n,toggleTheme:e,isNavOpen:t,toggleNav:r,version:o,setVersion:a}=Ut(),i=yo(),s=he(()=>[{title:"Learn",href:"/learn"},{title:"Docs",href:"/docs"},{title:"Examples",href:"/examples"},{title:"Acknowledgment",href:"/acknowledgment"}]),l=he(()=>[{title:"GitHub",href:"https://github.com/RiadhAdrani/ruvy"}]);return createJsxElement(createJsxFragmentElement,null,createJsxElement("div",{class:["row-center","w-100%","bg-[color:var(--primary)]","p-x-5","h-[var(--nav-bar-height)]","border-b border-b-1px border-b-solid border-[color:var(--border-low)]","fixed top-0px z-[var(--nav-bar-z)]"]},createJsxElement("div",{class:"row justify-between items-center max-w-1200px flex-1 z-2"},createJsxElement("div",{class:"row items-center gap-8"},createJsxElement("a",{href:{name:"Home"},class:"p-x-1 row-center gap-3"},createJsxElement("img",{src:i,class:"h-25px w-25px"}),createJsxElement("h2",{class:"hidden md:inline-block"},"Ruvy")),createJsxElement("div",{class:"row hidden md:flex gap-1"},s.map(c=>createJsxElement(Ne,{href:c.href,target:"_blank",isActive:It(c.href)},c.title)))),createJsxElement("div",{class:"row hidden gap-3 md:flex items-center"},createJsxElement("div",{class:"row gap-1"},l.map(c=>createJsxElement(Ne,{href:c.href,target:"_blank"},c.title))),createJsxElement("select",{onChange:c=>a(c.target.value)},Te.map(c=>createJsxElement("option",{key:c,selected:o===c,value:c},"v",c))),createJsxElement(Tr,{checked:n===de.Dark,onChange:()=>e()})),createJsxElement("div",{class:"col md:hidden"},createJsxElement(Ct,{type:"text",class:["nav-bar-mobile-btn col-center",t?"nav-bar-mobile-btn-expanded":""],onClick:()=>r()})))),createJsxElement("div",{class:["col md:hidden",t?"top-[var(--nav-bar-height)] opacity-100":"-top-100vh opacity-0","fixed left-0px right-0px","bg-[color:var(--primary)]","overflow-y-auto","duration-[var(--t-long)]","p-5","z-1"],style:{height:"calc(100vh - var(--nav-bar-height))"}},createJsxElement("div",{class:["col gap-3 p-y-5","border-b border-b-solid border-b-1px border-[color:var(--border-low)]"]},s.map(c=>createJsxElement(Ne,{href:c.href,class:"",target:"_blank",isActive:It(c.href),onClick:()=>r(!1)},c.title))),createJsxElement("div",{class:["col gap-3 p-y-5","border-b border-b-solid border-b-1px border-[color:var(--border-low)]"]},l.map(c=>createJsxElement(Ne,{href:c.href,target:"_blank"},c.title))),createJsxElement("div",{class:"row items-center justify-between p-y-5 text-[var(--text-low)]"},createJsxElement("p",{class:"p-x-2"},"Theme"),createJsxElement(Tr,{checked:n===de.Dark,onChange:()=>e()})),createJsxElement(go,null)))},hn=n=>{var s;const{item:e,root:t,onClick:r}=n,[o,a]=Re(!1),i=cn(()=>a(!o),o);return createJsxElement(createJsxFragmentElement,null,e.children?createJsxElement("details",{open:o},createJsxElement("summary",{onClick:i},createJsxElement(Ne,{...n,href:`${t}${e.path}`,isActive:It(`${t}${e.path}`),onClick:r,class:"m-y-2"},e.title)),createJsxElement("div",{class:"m-l-2 col border-l-solid  border-l-1px border-l-[color:var(--border)]"},(s=e.children)==null?void 0:s.map(l=>createJsxElement(hn,{item:{...l,path:`${e.path}${l.path}`},root:t,onClick:r},l.title)))):createJsxElement(Ne,{...n,href:`${t}${e.path}`,isActive:It(`${t}${e.path}`),onClick:r,class:"m-l-18px m-y-1"},e.title))},Qi=({items:n,root:e})=>{const[t,r]=Re(!1),[o,a]=bo(),i=()=>{const l=!t;r(l),l?o():a()},s=()=>{r(!1),a()};return createJsxElement(createJsxFragmentElement,null,createJsxElement("div",{class:["fixed top-[var(--nav-bar-height)]","w-[var(--side-bar-width)]","bg-[var(--primary)]","border-r border-r-solid border-r-[color:var(--border-low)]","overflow-hidden","hidden md:flex md:col"],style:{height:"calc(100vh - var(--nav-bar-height))"}},createJsxElement("div",{class:"col gap-2 overflow-auto p-y-10 w-[var(--side-bar-width)]",style:{height:"calc(100vh - var(--nav-bar-height))"}},n.map(l=>createJsxElement(hn,{item:l,root:e})))),createJsxElement("div",{class:"col md:hidden fixed right-0 left-0 top-[var(--nav-bar-height)] w-100%"},createJsxElement("p",{class:["text-[var(--text-low)] hover:text-[var(--text)]","p-y-1.5 w-100% cursor-pointer bg-[var(--primary)]","border-b p-x-6 border-b-solid border-b-[color:var(--border-low)]","h-[var(--side-bar-height)]"],onClick:()=>i()},"Menu"),createJsxElement("div",{class:["bg-[var(--primary)] fixed w-100% overflow-hidden",t?"bottom-0px opacity-100":"-bottom-100vh opacity-0"],style:{height:"calc(100vh - var(--nav-bar-height) - var(--side-bar-height))"}},createJsxElement("div",{class:"col gap-2 overflow-auto p-t-5 p-x-5",style:{height:"calc(100vh - var(--nav-bar-height) - var(--side-bar-height))"}},n.map(l=>createJsxElement(hn,{item:l,root:e,onClick:s}))))))},wo=(n,e)=>n.reduce((t,r)=>{const o=Te.indexOf(e);if(r.versions.some(i=>{if(i.from===e||i.to===e)return!0;const s=Te.indexOf(i.from);if(i.to){const l=Te.indexOf(i.to);if(s<=o&&o<=l)return!0}else if(s<=o)return!0;return!1})){const i=r.children?wo(r.children,e):void 0,s={...r,children:i};t.push(s)}return t},[]),Sr=({rootURL:n,sideBarItems:e})=>{const{version:t}=Ut(),r=he(()=>wo(e,t),[e,t]);return createJsxElement(createJsxFragmentElement,null,createJsxElement(Qi,{items:r,root:n}),createJsxElement("div",{class:["row overflow-x-none flex-1 justify-stretch self-stretch","m-l-0 md:m-l-[var(--side-bar-width)]","p-l-0 md:p-l-10"]},createJsxElement(st,null)))},vo=()=>createJsxElement("div",null,createJsxElement("h1",null,"Not found"),createJsxElement(Ne,{href:"/",class:"p-x-0!"},"Go back to Home page")),on=({versions:n})=>{const{version:e}=Ut(),t=he(()=>{const r=Te.indexOf(e);if(r===-1)throw"invalid version";for(const o of n){if(o.from===e||o.to===e)return o.md;const a=Te.indexOf(o.from);if(o.to){const i=Te.indexOf(o.to);if(a<=r&&r<=i)return o.md}else if(a<=r)return o.md}},[e,n]);return t?createJsxElement(qe,{content:t}):createJsxElement(vo,null)},Ki=[{path:"/",element:createJsxElement(createJsxFragmentElement,null,createJsxElement(Xi,null),createJsxElement("div",{class:"w-100% overflow-x-hidden row-center p-x-6 m-t-[var(--nav-bar-height)]",style:{minHeight:"calc(100vh - var(--nav-bar-height))"}},createJsxElement("div",{class:"col max-w-1200px flex-1 self-stretch overflow-x-hidden p-y-12 md:p-y-10"},createJsxElement(st,null)))),children:[{path:"",title:"Home",element:createJsxElement(fi,null),name:"Home"},{path:"/docs",title:"Docs",element:createJsxElement(xr,null)},{path:"/learn",title:"Learn",element:createJsxElement(Fr,null),name:"Learn"},{path:"/acknowledgment",title:"Acknowledgment",element:createJsxElement(bi,null)},{path:"/examples",title:"Examples",element:createJsxElement(wi,null)},{path:"/*",element:createJsxElement(vo,null)},{path:"/learn",element:createJsxElement(Sr,{rootURL:"/learn",sideBarItems:Cr}),children:[{path:"",element:createJsxElement(Fr,null)},...Cr.map(n=>({path:n.path,element:createJsxElement(on,{versions:n.versions})}))]},{path:"/docs",element:createJsxElement(Sr,{rootURL:"/docs",sideBarItems:Ar}),children:[{path:"",element:createJsxElement(xr,null)},...Ar.map(n=>({path:n.path,element:createJsxElement(st,null),children:[{path:"",element:createJsxElement(on,{versions:n.versions})},...n.children.map(e=>({path:e.path,element:createJsxElement(on,{versions:e.versions})}))]}))]}]}];Oa({routes:Ki,base:"/ruvy",transformTitle:n=>`${n} - Ruvy`,correctScrolling:!0});Ea({app:createJsxElement(ms,null),host:document.querySelector("#app")});
