...
\`\`\`
`,_i=`# Beyond React: Exploring Additional Features and Differences
...
`,$i=[{from:"0.5.0",to:"0.5.0",md:Oi},{from:"0.5.2",md:Ui}],zi=`# mountApp
...
`,Ji=[{from:"0.5.0",to:"0.5.0",md:zi},{from:"0.5.2",md:Hi}],Wi=`# useState
...
`,ji=[{from:"0.5.0",to:"0.5.0",md:Wi},{from:"0.5.2",md:Gi}],Zi=`# useEffect
...
`,ol=[{from:"0.5.0",to:"0.5.0",md:nl},{from:"0.5.2",md:rl}],al=`# API
...
- [\`<Portal/>\`](/docs/api/portal)
- [\`<Fragment/>\`](/docs/api/fragment)
`,il=[{from:"0.5.0",to:"0.5.0",md:al},{from:"0.5.2",md:sl}],ll=[{path:"/mountApp",versions:Ji,title:"mountApp"},{path:"/createRouter",versions:$i,title:"createRouter"},{path:"/createStore",versions:[{from:"0.5.0",to:"0.5.0",md:Bi}],title:"createStore"},{path:"/useState",versions:ji,title:"useState"},{path:"/useEffect",versions:Yi,title:"useEffect"},{path:"/useMemo",versions:Qi,title:"useMemo"},{path:"/useCallback",versions:tl,title:"useCallback"},{path:"/useContext",versions:[{from:"0.5.0",md:xi}],title:"useContext"},{path:"/useId",versions:ol,title:"useId"},{path:"/createContext",versions:[{from:"0.5.0",md:Fi}],title:"createContext"},{path:"/getParams",versions:[{from:"0.5.0",md:ki}],title:"getParams"},{path:"/getSearchParams",versions:[{from:"0.5.0",md:Ai}],title:"getSearchParams"},{path:"/getPathname",versions:[{from:"0.5.0",md:Ei}],title:"getPathname"},{path:"/replace",versions:[{from:"0.5.0",to:"0.5.0",md:kr}],element:kr,title:"replace"},{path:"/navigate",versions:[{from:"0.5.0",md:Ci}],title:"navigate"},{path:"/batch",versions:[{from:"0.5.0",to:"0.5.0",md:Er}],element:Er,title:"batch"},{path:"/outlet",versions:[{from:"0.5.0",md:Ti}],title:"<Outlet/>"},{path:"/fragment",versions:[{from:"0.5.0",md:Ri}],title:"<Fragment/>"},{path:"/portal",versions:[{from:"0.5.0",md:Si}],title:"<Portal/>"}],ul=[{path:"/class-attribute",versions:[{from:"0.5.0",md:Ii}],title:"Class attribute"},{path:"/joinClasses",versions:[{from:"0.5.0",md:Pi}],title:"joinClasses"},{path:"/if-directive",versions:[{from:"0.5.0",md:Mi}],title:"if directives"},{path:"/switch-directive",versions:[{from:"0.5.0",md:Li}],title:"switch directives"},{path:"/event-modifiers",versions:[{from:"0.5.0",md:Ni}],title:"Event modifiers"}],Ar=[{path:"/api",title:"API",children:ll,versions:il},{path:"/more",title:"More",children:ul,versions:[{from:"0.5.0",md:_i}]},{path:"/types",title:"Types",children:[],versions:[{from:"0.5.0",md:Di}]}],cl=`# Quick Start
