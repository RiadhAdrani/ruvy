...
\`\`\`
`,Ii=`# Beyond React: Exploring Additional Features and Differences
...
`,Wi=[{from:"0.5.0",to:"0.5.0",md:Hi},{from:"0.5.2",md:Ji}],Gi=`# useState
...
`,Zi=[{from:"0.5.0",to:"0.5.0",md:Gi},{from:"0.5.2",md:ji}],qi=`# useEffect
...
`,nl=[{from:"0.5.0",to:"0.5.0",md:el},{from:"0.5.2",md:tl}],rl=`# API
...
- [\`<Portal/>\`](/docs/api/portal)
- [\`<Fragment/>\`](/docs/api/fragment)
`,al=[{from:"0.5.0",to:"0.5.0",md:rl},{from:"0.5.2",md:ol}],sl=[{path:"/mountApp",versions:Wi,title:"mountApp"},{path:"/createRouter",versions:zi,title:"createRouter"},{path:"/createStore",versions:[{from:"0.5.0",to:"0.5.0",md:_i}],title:"createStore"},{path:"/useState",versions:Zi,title:"useState"},{path:"/useEffect",versions:Vi,title:"useEffect"},{path:"/useMemo",versions:Ki,title:"useMemo"},{path:"/useCallback",versions:nl,title:"useCallback"},{path:"/useContext",versions:[{from:"0.5.0",md:xi}],title:"useContext"},{path:"/useId",versions:[{from:"0.5.0",md:Fi}],title:"useId"},{path:"/createContext",versions:[{from:"0.5.0",md:ki}],title:"createContext"},{path:"/getParams",versions:[{from:"0.5.0",md:Ei}],title:"getParams"},{path:"/getSearchParams",versions:[{from:"0.5.0",md:Ci}],title:"getSearchParams"},{path:"/getPathname",versions:[{from:"0.5.0",md:Ai}],title:"getPathname"},{path:"/replace",versions:[{from:"0.5.0",to:"0.5.0",md:kr}],element:kr,title:"replace"},{path:"/navigate",versions:[{from:"0.5.0",md:Ti}],title:"navigate"},{path:"/batch",versions:[{from:"0.5.0",to:"0.5.0",md:Er}],element:Er,title:"batch"},{path:"/outlet",versions:[{from:"0.5.0",md:Si}],title:"<Outlet/>"},{path:"/fragment",versions:[{from:"0.5.0",md:Bi}],title:"<Fragment/>"},{path:"/portal",versions:[{from:"0.5.0",md:Ri}],title:"<Portal/>"}],il=[{path:"/class-attribute",versions:[{from:"0.5.0",md:Pi}],title:"Class attribute"},{path:"/joinClasses",versions:[{from:"0.5.0",md:Mi}],title:"joinClasses"},{path:"/if-directive",versions:[{from:"0.5.0",md:Li}],title:"if directives"},{path:"/switch-directive",versions:[{from:"0.5.0",md:Ni}],title:"switch directives"},{path:"/event-modifiers",versions:[{from:"0.5.0",md:Oi}],title:"Event modifiers"}],Ar=[{path:"/api",title:"API",children:sl,versions:al},{path:"/more",title:"More",children:il,versions:[{from:"0.5.0",md:Ii}]},{path:"/types",title:"Types",children:[],versions:[{from:"0.5.0",md:Di}]}],ll=`# Quick Start
