...
`,Oi=[{from:"0.5.0",to:"0.5.0",md:Li},{from:"0.5.2",md:Ni}],Ui=`# createContext
...
`,zi=[{from:"0.5.0",to:"0.5.0",md:Ui},{from:"0.5.2",md:$i}],Hi=`# mountApp
...
<iframe src="https://stackblitz.com/edit/ruvy-jewpid?embed=1&file=src%2FCount.tsx&hideExplorer=1&hideNavigation=1" class="stackblitz"></iframe>
`,ll=[{from:"0.5.0",to:"0.5.0",md:sl},{from:"0.5.2",md:il}],ul=`# API
