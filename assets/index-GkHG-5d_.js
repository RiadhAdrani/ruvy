...
\`\`\`
`,Ei=`# Beyond React: Exploring Additional Features and Differences
...
`,Ii=[{from:"0.5.0",to:"0.5.0",md:_i},{from:"0.5.2",md:Bi}],Pi=`# createComposable
...
`,Mi=[{from:"0.5.2",md:Pi}],Li=`# createContext
...
`,Oi=[{from:"0.5.0",to:"0.5.0",md:Li},{from:"0.5.2",md:Ni}],Ui=`# mountApp
...
`,$i=[{from:"0.5.0",to:"0.5.0",md:Ui},{from:"0.5.2",md:zi}],Hi=`# useState
...
`,Ji=[{from:"0.5.0",to:"0.5.0",md:Hi},{from:"0.5.2",md:ji}],Wi=`# useEffect
...
`,Zi=[{from:"0.5.0",to:"0.5.0",md:Wi},{from:"0.5.2",md:Gi}],qi=`# useMemo
...
`,Vi=[{from:"0.5.0",to:"0.5.0",md:qi},{from:"0.5.2",md:Yi}],Xi=`# useCallback
...
`,Ki=[{from:"0.5.0",to:"0.5.0",md:Xi},{from:"0.5.2",md:Qi}],el=`# useId
...
`,nl=[{from:"0.5.0",to:"0.5.0",md:el},{from:"0.5.2",md:tl}],rl=`# useContext
...
<iframe src="https://stackblitz.com/edit/ruvy-jewpid?embed=1&file=src%2FCount.tsx&hideExplorer=1&hideNavigation=1" class="stackblitz"></iframe>
`,al=[{from:"0.5.0",to:"0.5.0",md:rl},{from:"0.5.2",md:ol}],sl=`# useComposable
...
<iframe src="https://stackblitz.com/edit/ruvy-lqiij9?embed=1&file=src%2FCount.tsx&hideExplorer=1&hideNavigation=1" class="stackblitz"></iframe>
`,il=[{from:"0.5.2",md:sl}],ll=`# getParams
...
\`\`\`
`,cl=[{from:"0.5.0",to:"0.5.0",md:ul},{from:"0.5.2",md:ll}],dl=`# getSearchParams
...
\`\`\`
`,pl=[{from:"0.5.0",to:"0.5.0",md:hl},{from:"0.5.2",md:dl}],ml=`# getPathname
...
\`\`\`
`,gl=[{from:"0.5.0",to:"0.5.0",md:fl},{from:"0.5.2",md:ml}],bl=`# navigate
...
`,Dl=[{from:"0.5.0",to:"0.5.0",md:vl},{from:"0.5.2",md:xl}],Fl=`# API
...
- [\`<Portal/>\`](/docs/api/portal)
- [\`<Fragment/>\`](/docs/api/fragment)
`,El=[{from:"0.5.0",to:"0.5.0",md:Fl},{from:"0.5.2",md:kl}],Cl=[{path:"/mountApp",versions:$i,title:"mountApp"},{path:"/createRouter",versions:Ii,title:"createRouter"},{path:"/createStore",versions:[{from:"0.5.0",to:"0.5.0",md:ki}],title:"createStore"},{path:"/createComposable",versions:Mi,title:"createComposable"},{path:"/useState",versions:Ji,title:"useState"},{path:"/useEffect",versions:Zi,title:"useEffect"},{path:"/useMemo",versions:Vi,title:"useMemo"},{path:"/useCallback",versions:Ki,title:"useCallback"},{path:"/useContext",versions:al,title:"useContext"},{path:"/useComposable",versions:il,title:"useComposable"},{path:"/useId",versions:nl,title:"useId"},{path:"/createContext",versions:Oi,title:"createContext"},{path:"/getParams",versions:cl,title:"getParams"},{path:"/getSearchParams",versions:pl,title:"getSearchParams"},{path:"/getPathname",versions:gl,title:"getPathname"},{path:"/replace",versions:[{from:"0.5.0",to:"0.5.0",md:kr}],element:kr,title:"replace"},{path:"/navigate",versions:wl,title:"navigate"},{path:"/batch",versions:[{from:"0.5.0",to:"0.5.0",md:Er}],element:Er,title:"batch"},{path:"/outlet",versions:Dl,title:"<Outlet/>"},{path:"/fragment",versions:[{from:"0.5.0",md:Fi}],title:"<Fragment/>"},{path:"/portal",versions:[{from:"0.5.0",md:Di}],title:"<Portal/>"}],Al=[{path:"/class-attribute",versions:[{from:"0.5.0",md:Ci}],title:"Class attribute"},{path:"/joinClasses",versions:[{from:"0.5.0",md:Ai}],title:"joinClasses"},{path:"/if-directive",versions:[{from:"0.5.0",md:Ti}],title:"if directives"},{path:"/switch-directive",versions:[{from:"0.5.0",md:Si}],title:"switch directives"},{path:"/event-modifiers",versions:[{from:"0.5.0",md:Ri}],title:"Event modifiers"}],Cr=[{path:"/api",title:"API",children:Cl,versions:El},{path:"/more",title:"More",children:Al,versions:[{from:"0.5.0",md:Ei}]},{path:"/types",title:"Types",children:[],versions:[{from:"0.5.0",md:xi}]}],Tl=`# Quick Start
...
- SPA Router.
- key-value Store.
`,Pl=()=>createJsxElement(Ue,{content:Il}),Ml=[{path:"/",element:createJsxElement(createJsxFragmentElement,null,createJsxElement(_l,null),createJsxElement("div",{class:"w-100% overflow-x-hidden row-center p-x-6 m-t-[var(--nav-bar-height)]",style:{minHeight:"calc(100vh - var(--nav-bar-height))"}},createJsxElement("div",{class:"col max-w-1200px flex-1 self-stretch overflow-x-hidden p-y-12 md:p-y-10"},createJsxElement(st,null)))),children:[{path:"",title:"Home",element:createJsxElement(mi,null),name:"Home"},{path:"/docs",title:"Docs",element:createJsxElement(Dr,null)},{path:"/learn",title:"Learn",element:createJsxElement(Fr,null),name:"Learn"},{path:"/changelogs",title:"Changelogs",element:createJsxElement(Pl,null),name:"ChangeLogs"},{path:"/acknowledgment",title:"Acknowledgment",element:createJsxElement(bi,null)},{path:"/examples",title:"Examples",element:createJsxElement(wi,null)},{path:"/*",element:createJsxElement(wo,null)},{path:"/learn",element:createJsxElement(Sr,{rootURL:"/learn",sideBarItems:Ar}),children:[{path:"",element:createJsxElement(Fr,null)},...Ar.map(n=>({path:n.path,element:createJsxElement(on,{versions:n.versions})}))]},{path:"/docs",element:createJsxElement(Sr,{rootURL:"/docs",sideBarItems:Cr}),children:[{path:"",element:createJsxElement(Dr,null)},...Cr.map(n=>({path:n.path,element:createJsxElement(st,null),children:[{path:"",element:createJsxElement(on,{versions:n.versions})},...n.children.map(e=>({path:e.path,element:createJsxElement(on,{versions:e.versions})}))]}))]}]}];Oa({routes:Ml,base:"/ruvy",transformTitle:n=>`${n} - Ruvy`,correctScrolling:!0});ka({app:createJsxElement(fs,null),host:document.querySelector("#app")});
