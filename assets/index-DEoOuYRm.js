...
\`\`\`
`,Mi=`# Beyond React: Exploring Additional Features and Differences
...
`,Ji=[{from:"0.5.0",to:"0.5.0",md:zi},{from:"0.5.2",md:Hi}],Wi=`# mountApp
...
`,ji=[{from:"0.5.0",to:"0.5.0",md:Wi},{from:"0.5.2",md:Gi}],Zi=`# useState
...
`,qi=[{from:"0.5.0",to:"0.5.0",md:Zi},{from:"0.5.2",md:Yi}],Vi=`# useEffect
...
`,Qi=[{from:"0.5.0",to:"0.5.0",md:Vi},{from:"0.5.2",md:Xi}],Ki=`# API
...
- [\`<Portal/>\`](/docs/api/portal)
- [\`<Fragment/>\`](/docs/api/fragment)
`,tl=[{from:"0.5.0",to:"0.5.0",md:Ki},{from:"0.5.2",md:el}],nl=[{path:"/mountApp",versions:ji,title:"mountApp"},{path:"/createRouter",versions:Ji,title:"createRouter"},{path:"/createStore",versions:[{from:"0.5.0",to:"0.5.0",md:Pi}],title:"createStore"},{path:"/useState",versions:qi,title:"useState"},{path:"/useEffect",versions:Qi,title:"useEffect"},{path:"/useMemo",versions:[{from:"0.5.0",md:xi}],title:"useMemo"},{path:"/useCallback",versions:[{from:"0.5.0",md:Fi}],title:"useCallback"},{path:"/useContext",versions:[{from:"0.5.0",md:Ei}],title:"useContext"},{path:"/useId",versions:[{from:"0.5.0",md:ki}],title:"useId"},{path:"/createContext",versions:[{from:"0.5.0",md:Ai}],title:"createContext"},{path:"/getParams",versions:[{from:"0.5.0",md:Ci}],title:"getParams"},{path:"/getSearchParams",versions:[{from:"0.5.0",md:Si}],title:"getSearchParams"},{path:"/getPathname",versions:[{from:"0.5.0",md:Ti}],title:"getPathname"},{path:"/replace",versions:[{from:"0.5.0",to:"0.5.0",md:Er}],element:Er,title:"replace"},{path:"/navigate",versions:[{from:"0.5.0",md:Ri}],title:"navigate"},{path:"/batch",versions:[{from:"0.5.0",to:"0.5.0",md:kr}],element:kr,title:"batch"},{path:"/outlet",versions:[{from:"0.5.0",md:Bi}],title:"<Outlet/>"},{path:"/fragment",versions:[{from:"0.5.0",md:Ii}],title:"<Fragment/>"},{path:"/portal",versions:[{from:"0.5.0",md:_i}],title:"<Portal/>"}],rl=[{path:"/class-attribute",versions:[{from:"0.5.0",md:Li}],title:"Class attribute"},{path:"/joinClasses",versions:[{from:"0.5.0",md:Ni}],title:"joinClasses"},{path:"/if-directive",versions:[{from:"0.5.0",md:Oi}],title:"if directives"},{path:"/switch-directive",versions:[{from:"0.5.0",md:Ui}],title:"switch directives"},{path:"/event-modifiers",versions:[{from:"0.5.0",md:$i}],title:"Event modifiers"}],Ar=[{path:"/api",title:"API",children:nl,versions:tl},{path:"/more",title:"More",children:rl,versions:[{from:"0.5.0",md:Mi}]},{path:"/types",title:"Types",children:[],versions:[{from:"0.5.0",md:Di}]}],ol=`# Quick Start
