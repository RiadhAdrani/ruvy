...
`,Wi=`# Beyond React: Exploring Additional Features and Differences
...
`,qi=[{path:"/mountApp",versions:[{from:"0.5.0",to:"0.5.0",md:Ui},{from:"0.5.2",md:$i}],title:"mountApp"},{path:"/createRouter",versions:[{from:"0.5.0",to:"0.5.0",md:zi},{from:"0.5.2",md:Hi}],title:"createRouter"},{path:"/createStore",versions:[{from:"0.5.0",to:"0.5.0",md:Oi}],title:"createStore"},{path:"/useState",versions:[{from:"0.5.0",md:Ei}],title:"useState"},{path:"/useEffect",versions:[{from:"0.5.0",md:ki}],title:"useEffect"},{path:"/useMemo",versions:[{from:"0.5.0",md:Ai}],title:"useMemo"},{path:"/useCallback",versions:[{from:"0.5.0",md:Ci}],title:"useCallback"},{path:"/useContext",versions:[{from:"0.5.0",md:Ti}],title:"useContext"},{path:"/useId",versions:[{from:"0.5.0",md:Si}],title:"useId"},{path:"/createContext",versions:[{from:"0.5.0",md:Ri}],title:"createContext"},{path:"/getParams",versions:[{from:"0.5.0",md:Bi}],title:"getParams"},{path:"/getSearchParams",versions:[{from:"0.5.0",md:Ii}],title:"getSearchParams"},{path:"/getPathname",versions:[{from:"0.5.0",md:_i}],title:"getPathname"},{path:"/replace",versions:[{from:"0.5.0",to:"0.5.0",md:Er}],element:Er,title:"replace"},{path:"/navigate",versions:[{from:"0.5.0",md:Pi}],title:"navigate"},{path:"/batch",versions:[{from:"0.5.0",to:"0.5.0",md:kr}],element:kr,title:"batch"},{path:"/outlet",versions:[{from:"0.5.0",md:Mi}],title:"<Outlet/>"},{path:"/fragment",versions:[{from:"0.5.0",md:Ni}],title:"<Fragment/>"},{path:"/portal",versions:[{from:"0.5.0",md:Li}],title:"<Portal/>"}],Vi=[{path:"/class-attribute",versions:[{from:"0.5.0",md:Gi}],title:"Class attribute"},{path:"/joinClasses",versions:[{from:"0.5.0",md:Ji}],title:"joinClasses"},{path:"/if-directive",versions:[{from:"0.5.0",md:ji}],title:"if directives"},{path:"/switch-directive",versions:[{from:"0.5.0",md:Zi}],title:"switch directives"},{path:"/event-modifiers",versions:[{from:"0.5.0",md:Yi}],title:"Event modifiers"}],Ar=[{path:"/api",title:"API",children:qi,versions:[{from:"0.5.0",to:"0.5.0",md:Di},{from:"0.5.2",md:xi}]},{path:"/more",title:"More",children:Vi,versions:[{from:"0.5.0",md:Wi}]},{path:"/types",title:"Types",children:[],versions:[{from:"0.5.0",md:Fi}]}],Xi=`# Quick Start
